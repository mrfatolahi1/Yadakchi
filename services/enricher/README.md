...
Turns raw listings into Offers: Persian normalization, field extraction, and the minting of `offer_uid`.
...
they are everything you need: you own `services/enricher/` and nothing else, you

...
Decides which Offers are the same physical product, and mints `cluster_uid`. This is the heart of the product.
...
they are everything you need: you own `services/matcher/` and nothing else, you

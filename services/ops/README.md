...
Internal console: review queue, seller dashboard, and the human decisions that override everything computed.
...
they are everything you need: you own `services/ops/` and nothing else, you

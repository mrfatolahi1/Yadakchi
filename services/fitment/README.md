...
Owns the vehicle tree, part-to-vehicle mapping and cross-references — the answer to "does this part fit my car?".
...
they are everything you need: you own `services/fitment/` and nothing else, you

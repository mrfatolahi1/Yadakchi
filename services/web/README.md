...
The public Next.js website — server-rendered, because SEO is the primary acquisition channel.
...
they are everything you need: you own `services/web/` and nothing else, you
